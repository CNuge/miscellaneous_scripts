...
if __name__ == '__main__':
	...
	snp_input_file1 = './snp_files/icelandic_Final_SNPs_Missing_From_Stacks_SNP_info_file.txt'
...
#	snp_input_dat.head()
	...
	polymorphism_vcf.to_csv('icelandic_snps_late_additions.vcf', sep='\t',index=False)
