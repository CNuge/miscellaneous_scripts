...
input_sam_file = './sam_files/norman_SNPs_in_both_F10_F12_contigs_Output.sam'

secondary_alignments_out = 'norman_secondary_alignments.sam'
alignments_one_location = 'norman_samfile_one_location_alignments.sam'
